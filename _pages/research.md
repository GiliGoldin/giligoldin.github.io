...
![VAD prediction combined model flow]({{ "/images/papers/polarization/model-diagram_color-3.png" | relative_url }})

*Figure: The Encoder LLM receives a sentence as input and generates its sentence embedding. This embedding is then used as input for the regression models, which predict the Valence (V), Arousal (A), and Dominance (D) scores for the sentence.*


*Figure: The Encoder LLM receives a sentence as input and
